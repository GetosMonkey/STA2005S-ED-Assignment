...
decision_tbl <- emm_hl_sum |>
  ...
  select(heat, light, mean, lower, upper, delta_vs_best)

decision_tbl

# Optional: pick a near-optimal, cheaper setting (within 2 unit of best)
near_optimal <- decision_tbl |>
  filter(delta_vs_best >= -2.0) |>
  arrange(heat + light)  # crude proxy for energy cost
near_optimal
